    ...
    projekktor = $p = function () {
        ...
        function PPlayer(srcNode, cfg, onReady) {
            ...
            this._prepareMedia = function (data) {
                var ref = this, mediaFiles = [], qualities = [], extTypes = {}, typesModels = {}, priority = [], modelSets = [];
                result = {}, extRegEx = [];
                for (var i in $p.mmap) {
            ...
            this._enterFullViewport = function (forcePlayer, addClass) {
                var win = this.getIframeWindow() || $(window), target = this.getIframe() || this.getDC();
                if (forcePlayer) {
                    win = $(window);
                    target = this.getDC()
                }
            ...
            this.getIosVersion = function (type) {
                var agent = navigator.userAgent.toLowerCase(), start = agent.indexOf("os ");
            ...
            this.setActiveItem = function (mixedData) {
                var newItem = 0, lastItem = this._currentItem, ref = this;
                ...
                for (var i = 0; i < $p.mmap.length; i++) {
                    ...
                    $.each(platforms, function (_na, platform) {
                        ...
                        $.each(streamType, function (key, st) {
                            ...
                            var capped = $p.utils.capitalise(platform), version = $p.models[$p.mmap[i]["model"].toUpperCase()].prototype[(platform.toLowerCase()) + "Version"] || 1;
                            try {
...
jQuery(function (a) {
    $p.utils = {
        ...
        randomId: function (f) {
            var e = "abcdefghiklmnopqrstuvwxyz", b = "";
            for (var d = 0; d < f; d++) {
        ...
        toTimeString: function (e, h) {
            var c = Math.floor(e / (60 * 60)), f = e % (60 * 60), d = Math.floor(f / 60), b = f % 60, g = Math.floor(b);
            if (c < 10) {
                c = "0" + c
            }
            if (d < 10) {
        ...
        embeddFlash: function (d, c, k) {
            var f = c.FlashVars || {}, m = "", e = "", l = "", g = "", h = d, b = "";
            if (c.src.indexOf("?") == -1) {
                c.src += "?"
            } else {
                c.src += "&"
        ...
        ieVersion: function () {
            var b = 3, d = document.createElement("div"), c = d.getElementsByTagName("i");
        ...
        stretch: function (f, g, n, l, d, h) {
            ...
            var e = (d !== undefined) ? d : g.data("od").width, b = (h !== undefined) ? h : g.data("od").height, j = (n / e), m = (l / b), c = n, k = l;
            switch (f) {
                case"none":
                    c = e;
                    k = b;
        ...
        parseUri: function (f) {
            ...
            }, b = e.parser[e.strictMode ? "strict" : "loose"].exec(f), d = {}, c = 14;
            while (c--) {
                d[e.key[c]] = b[c] || ""
            }
            d[e.q.name] = {};
...
jQuery(function (a) {
    projekktorPluginInterface.prototype = {
        ...
        applyToPlayer: function (c, f, e) {
            ...
            var d = f || "container", b = c.attr("class") || this.name;
...
projekktorConfig.prototype = {
    ...
    "playerFlashMP4": "packages/js/jarisplayer.swf",
    "playerFlashMP3": "packages/js/jarisplayer.swf",
    "streamType": "http",
    "streamServer": "",
    "useYTIframeAPI": true,
    "enableKeyboard": true,
    ...
    projekktorDisplay.prototype = {
        ...
        showBufferIcon: function (b) {
            ...
            this.buffIcn.fadeIn("fast", function () {
                ...
                var d = (c.config.spriteCountUp == true) ? 0 : (c.config.spriteHeight + c.config.spriteOffset) * (c.config.spriteTiles - 1), e = d;
...
jQuery(function ($) {
    projekktorControlbar.prototype = {
        ...
        config: {
            ...
            showOnIdle: false,
            /* Default layout */
            controlsTemplate: '<ul class="left"><li><div %{play}></div><div %{pause}></div></li><li><div style="color: #fff; border-left: 1px solid #413E3E; font-size: 11px; height: 30px; line-height: 30px; padding: 0 10px; text-align: left;">' + document.title + '</div></li></ul><ul class="right"><li><div %{fsexit}></div><div id="tests" %{fsenter}><img src="Untitled.png" style="position: relative;margin-left: 4px;margin-top: -16px;width: 95px;"></div></li><li><div %{loquality}></div><div %{hiquality}></div></li><li><div %{tracksbtn}></div></li><li><div %{vmax}></div></li><li><div %{vslider}><div %{vmarker}></div><div %{vknob}></div></div></li><li><div %{mute}></div></li><li><div %{timeleft}>%{hr_elp}:%{min_elp}:%{sec_elp} | %{hr_dur}:%{min_dur}:%{sec_dur}</div></li><li><div %{next}></div></li><li><div %{prev}></div></li></ul><ul class="bottom"><li><div %{scrubber}><div %{loaded}></div><div %{playhead}></div><div %{scrubberdrag}></div></div></li></ul><div %{scrubbertip}>%{hr_tip}:%{min_tip}:%{sec_tip}</div>'
        },
        initialize: function () {
            var ref = this,
        ...
        showcb: function (fade) {
            ...
            if (this.cb == null)
                return;
            if ("IDLE|AWAKENING|ERROR".indexOf(this.pp.getState()) > -1 && fade != true)
                return;
        ...
        muteClk: function (evt) {
            ...
            $('.ppmute').css('color','white');
            this.controlElements['vmarker'].css('width',  "0%");
        ...
        vmaxClk: function (evt) {
           // this.cookie('muted', false);
           this.controlElements['vmarker'].css('width',  "100%");
            this.controlElements['vknob'].css('left',  "100%");
            this.pp.setVolume(1);
        },
        ...
        vsliderClk: function (evt) {
            ...
            this.controlElements['vmarker'].css('width', result * 100 + "%");
                this.controlElements['vknob'].css('left', result * 100 + "%");
